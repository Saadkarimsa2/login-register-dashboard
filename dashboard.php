...
if(!empty($_SESSION["id"])){
    $id = $_SESSION["id"];
    echo "<script>console.log('Session ID in dashboard: $id');</script>";
}
 else {
...
<head>
    ...
    <title>Zenix -   Admin Dashboard </title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://example.com/" target="_blank">example</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
